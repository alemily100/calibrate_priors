...
true_tox_clin<- rbind.data.frame(c(0.05, 0.10, 0.12, 0.15, 0.20), c(0.10, 0.12, 0.15, 0.20, 0.25), c(0.12, 0.15, 0.20, 0.25, 0.40),
...
set.seed(1001)
ntrial<-1250
cohortsize=cohortsize      ##cohort size for each inclusion
n.stop=ncohort
