...
for (i in 1:9){
  ...
  print(all_sim)
  write.csv(all_sim, paste0("marginal.clay", phi,".", ncohort,".", cohortsize,".csv"))
  write.csv(prob_dlt[[4]], paste0("marginal.clay", phi, ".sim", i, ".", ncohort, ".", cohortsize, ".csv"))
  write.csv(prob_dlt[[2]], paste0("marginal.clay", phi, ".sim", i, ".", ncohort, ".", cohortsize, ".cdlt.csv"))
  write.csv(prob_dlt[[3]], paste0("marginal.clay", phi, ".sim", i, ".", ncohort, ".", cohortsize, ".pdlt.csv"))
}
...
eval(parse(text=paste0("write.csv(l, 'l.", ncohort,".csv')")))
...
eval(parse(text=paste0("write.csv(c(ac.",ncohort,", bc.", ncohort, ", ap.", ncohort, ", bp.", ncohort,"), 'best.sr.", ncohort,".csv')")))
...
for (i in 1:8){
  ...
  all_sim<-rbind.data.frame(all_sim, sim)
  print(all_sim)
  write.csv(all_sim, paste0("joint.clay",phi,".", ncohort, ".", cohortsize, ".csv"))
  write.csv(prob_dlt[[4]], paste0("joint.clay", phi, ".sim", i, ".", ncohort, ".", cohortsize, ".csv"))
  write.csv(prob_dlt[[2]], paste0("joint.clay", phi, ".sim", i, ".", ncohort, ".", cohortsize, ".cdlt.csv"))
  write.csv(prob_dlt[[3]], paste0("joint.clay", phi, ".sim", i, ".", ncohort, ".", cohortsize, ".pdlt.csv"))
}
