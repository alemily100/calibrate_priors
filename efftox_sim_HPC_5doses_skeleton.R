...
mtd<- 3
 ...
 skeletonc<- getprior(delta, target, mtd, nlevel=5)
 
 eff1<- getprior(delta, 0.60, 5, nlevel=5)
 eff2<- c(eff1[2], eff1[3], eff1[4], eff1[5], eff1[4])
 eff3<- c(eff1[3], eff1[4], eff1[5], eff1[4], eff1[3])
 eff4<- c(eff1[4], eff1[5], eff1[4], eff1[3], eff1[2])
 eff5<- c(eff1[5], eff1[4], eff1[3], eff1[2], eff1[1])
 eff6<- rep(eff1[5], times=5)
 eff7<- c(eff1[4], rep(eff1[5], times=4))
 eff8<- c(eff1[3], eff1[4], rep(eff1[5], times=3))
 eff9<-c(eff1[2], eff1[3], eff1[4], eff1[5], eff1[5])
...
#     print(all_sim)
#     write.csv(n, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/joint/",delta,"sim", i,".",j, ".pat.allocation", ncohort, ".", cohortsize, ".csv"))
#     write.csv(yc, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/joint/",delta,"sim", i,".",j, ".", ncohort, ".", cohortsize, ".cdlt.csv"))
#     write.csv(ye, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/joint/",delta,"sim",i,".",j, ".", ncohort, ".", cohortsize, ".eff.csv"))
#   }
# }
# write.csv(all_sim, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/joint/",delta,"sim.", ncohort,".", cohortsize,".csv"))
# 
# 
# 
...
#   all_sim<-rbind.data.frame(all_sim, sim)
#   print(all_sim)
#   write.csv(n, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/marginal_lognormal/",delta,"sim", i,".",j, ".pat.allocation", ncohort, ".", cohortsize, ".csv"))
#   write.csv(yc, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/marginal_lognormal/",delta,"sim", i, ".", j, ".", ncohort, ".", cohortsize, ".cdlt.csv"))
#   write.csv(ye, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/marginal_lognormal/",delta,"sim", i, ".", j, ".", ncohort, ".", cohortsize, ".eff.csv"))
#   }
# }
# write.csv(all_sim, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/marginal_lognormal/",delta,"sim.", ncohort,".", cohortsize,".csv"))
...
for (i in 1:6){
  for(j in 1:9){
    ...
    all_sim<-rbind.data.frame(all_sim, sim)
    print(all_sim)
    write.csv(n, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/marginal_gamma/",delta,"sim", i,".",j, ".pat.allocation", ncohort, ".", cohortsize, ".csv"))
    write.csv(yc, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/marginal_gamma/",delta,"sim", i, ".", j, ".", ncohort, ".", cohortsize, ".cdlt.csv"))
    write.csv(ye, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/marginal_gamma/",delta,"sim", i, ".", j, ".", ncohort, ".", cohortsize, ".eff.csv"))
  }
}
write.csv(all_sim, paste0("/home/ealger/revision_calibrate_priors/results/efftox_results/delta/marginal_gamma/",delta,"sim.", ncohort,".", cohortsize,".csv"))
